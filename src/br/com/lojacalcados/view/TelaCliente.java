...
public class TelaCliente extends JFrame {
	...
	public TelaCliente() {
		...
		txtNomeCliente.setBounds(176, 11, 156, 20);
		...
		txtNumero.setBounds(123, 58, 108, 20);
		pnlEndereco.add(txtNumero);
		
		txtComplemento = new JTextField();
		txtComplemento.setColumns(10);
		txtComplemento.setBounds(123, 83, 108, 20);
		pnlEndereco.add(txtComplemento);
		
		txtBairro = new JTextField();
		txtBairro.setColumns(10);
		txtBairro.setBounds(401, 33, 196, 20);
		pnlEndereco.add(txtBairro);
		
		txtCidade = new JTextField();
		txtCidade.setColumns(10);
		txtCidade.setBounds(401, 58, 196, 20);
		...
		txtLogradouro.setBounds(123, 33, 108, 20);
